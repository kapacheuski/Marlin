...
#define MAX_E_STEPPERS 8
  ...
  #elif MB(RAMPS_13_EEB, RAMPS_14_EEB, RAMPS_PLUS_EEB, RAMPS_14_RE_ARM_EEB, RAMPS_SMART_EEB, RAMPS_DUO_EEB, RAMPS4DUE_EEB, RAMPS_14_OPENPNP)
...
//
  ...
  #include "ramps/pins_RAMPS_OPENPNP.h"         // ATmega2560                             env:mega2560
